...
CONF_CODE = {
    ...
    "invalid_urlName"          : ( 1004, "no such module online address"           ),
    "invalid_errorCode"        : ( 1005, "no such module error code"               ),
    "invalid_action"           : ( 1006, "no such module action"                   ),
    ...
    "duplicate_module_urlName" : ( 1203, "duplicate module urlName"                ),
    "duplicate_module_code"    : ( 1204, "duplicate module error code"             ),
    "duplicate_module_action"  : ( 1205, "duplicate module action"                 ),
